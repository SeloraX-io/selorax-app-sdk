...
class SeloraxApi {
    constructor(config = {}) {
        ...
        this.orders = {
            ...
            create: (storeId, body) => this.post(storeId, '/apps/v1/orders', body),
            update: (storeId, orderId, body) => this.put(storeId, `/apps/v1/orders/${orderId}`, body),
            updateStatus: (storeId, orderId, body) => this.put(storeId, `/apps/v1/orders/${orderId}/status`, body),
        };
        ...
        this.products = {
            ...
            create: (storeId, body) => this.post(storeId, '/apps/v1/products', body),
            update: (storeId, productId, body) => this.put(storeId, `/apps/v1/products/${productId}`, body),
            delete: (storeId, productId) => this.del(storeId, `/apps/v1/products/${productId}`),
            addVariant: (storeId, productId, body) => this.post(storeId, `/apps/v1/products/${productId}/variants`, body),
            updateVariant: (storeId, productId, skuId, body) => this.put(storeId, `/apps/v1/products/${productId}/variants/${skuId}`, body),
            deleteVariant: (storeId, productId, skuId) => this.del(storeId, `/apps/v1/products/${productId}/variants/${skuId}`),
        };
        ...
        this.customers = {
            ...
            create: (storeId, body) => this.post(storeId, '/apps/v1/customers', body),
            update: (storeId, userId, body) => this.put(storeId, `/apps/v1/customers/${userId}`, body),
            delete: (storeId, userId) => this.del(storeId, `/apps/v1/customers/${userId}`),
            getOrders: (storeId, userId, params) => this.get(storeId, `/apps/v1/customers/${userId}/orders`, params),
        };
        ...
        this.inventory = {
            ...
            get: (storeId, productId) => this.get(storeId, `/apps/v1/inventory/${productId}`),
            listAll: (storeId, params) => this.paginate(storeId, '/apps/v1/inventory', params),
            set: (storeId, productId, body) => this.put(storeId, `/apps/v1/inventory/${productId}`, body),
            adjust: (storeId, productId, body) => this.post(storeId, `/apps/v1/inventory/${productId}/adjust`, body),
        };
        ...
        this.discounts = {
            list: (storeId, params) => this.get(storeId, '/apps/v1/discounts', params),
            get: (storeId, discountId) => this.get(storeId, `/apps/v1/discounts/${discountId}`),
            listAll: (storeId, params) => this.paginate(storeId, '/apps/v1/discounts', params),
            validate: (storeId, code) => this.get(storeId, `/apps/v1/discounts/validate/${encodeURIComponent(code)}`),
            create: (storeId, body) => this.post(storeId, '/apps/v1/discounts', body),
            update: (storeId, discountId, body) => this.put(storeId, `/apps/v1/discounts/${discountId}`, body),
            delete: (storeId, discountId) => this.del(storeId, `/apps/v1/discounts/${discountId}`),
        };
    }
...
module.exports = {
    ...
    discounts: defaultInstance.discounts,
};
